...
var newDiv = $('<div id="imaForTag" tabindex="0"></div>);');newDiv.css({height:"190px",width:"200px",position:"relative",padding: "0px",margin: "0px",float:"right"});
...
backgroundColor: "rgba(255,255,255,0.5)",top: "0",left: "0",display: "flex",alignItems: "center",justifyContent: "center",zindex: 500});
...
newDiv.css({height: "190px",width: "200px",position: "relative",padding: "0px",margin: "0px",float: "right",clear: "right"});var src_mp4="";var src_ogv="";
